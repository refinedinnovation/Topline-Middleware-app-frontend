...
const userSchema = new mongoose_1.Schema({
    _id: {
        type: mongoose_1.Schema.Types.ObjectId, // Corrected: Using Schema.Types.ObjectId
        default: () => new mongoose_1.Types.ObjectId(), // Correctly generates a MongoDB ObjectId
    },
    firstName: { type: String, required: true, trim: true },
    lastName: { type: String, required: true, trim: true },
    email: {
